...
@Composable
fun WelcomeSheet(
    onComplete: (trustedNumber: String, policy: ForwardingPolicy) -> Unit,
    onDismiss: () -> Unit,
) {
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            when (step) {
                ...
                1 -> {
                    ...
                    OutlinedTextField(
                        ...
                        label = { Text(stringResource(R.string.welcome_trusted_number)) },
            ...
            PrimaryActionButton(
                ...
                enabled = step != 1 || trustedNumber.isNotBlank(),
            )
            if (step < TOTAL_STEPS - 1) {
                TextButton(
                    onClick = onDismiss,
