...
internal fun SessionEntity.toDomain(): AuthorizationSession {
    ...
    return AuthorizationSession(
        ...
        destinationSnapshots = DestinationSnapshot.decodeList(destinationSnapshotsJson),
        untilStop = untilStop,
...
internal fun AuthorizationSession.toEntity(): SessionEntity {
    ...
    return SessionEntity(
        ...
        destinationSnapshotsJson = DestinationSnapshot.encodeList(destinationSnapshots),
        untilStop = untilStop,
    )
}
