...
APK_BASENAME="${APK_BASENAME:-khidki-${VERSION_NAME}-debug-b${VERSION_CODE}-${SHORT_SHA}.apk}"
...
2. Install over an existing Khidki debug build — same signing key, higher version code required.
